        ...
        <main className='upcoming-container'>
            ...
            <section className='upcoming-event-container'>
                <div className='upcoming-event-title'>
                    <h2 className='upcoming-event-title-info'>Saturday, October 7th</h2>
                    <h2 className='upcoming-event-title-info'>Sports Card & Memorabilia Show</h2>
                    <h2 className='upcoming-event-title-info'>Friendly Sons of the Shillelagh</h2>
                </div>
                <div id='upcoming-event1-banner-container' className='upcoming-event-banner-container'>
